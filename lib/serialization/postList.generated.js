    ...
    outreach.postlist = (function() {
        ...
        postlist.v1 = (function() {
            ...
            v1.Post = (function() {
                 ...
                 * @property {boolean|null} [trackingEnabled] Post trackingEnabled
                 * @property {number|Long|null} [trackingExpiresAtMs] Post trackingExpiresAtMs
                 * @property {Array.<Uint8Array>} [$unknowns] Unknown fields preserved while decoding when enabled
                 */
                 ...
                 * @member {boolean|null|undefined} trackingEnabled
                 * @memberof outreach.postlist.v1.Post
                 * @instance
                 */
                Post.prototype.trackingEnabled = null;

                /**
                 * Post trackingExpiresAtMs.
                 * @member {number|Long|null|undefined} trackingExpiresAtMs
                 * @memberof outreach.postlist.v1.Post
                 * @instance
                 */
                Post.prototype.trackingExpiresAtMs = null;
                ...
                // Virtual OneOf for proto3 optional field
                $Object.defineProperty(Post.prototype, "_trackingEnabled", {
                    get: $util.oneOfGetter($oneOfFields = ["trackingEnabled"]),
                    set: $util.oneOfSetter($oneOfFields)
                });

                // Virtual OneOf for proto3 optional field
                $Object.defineProperty(Post.prototype, "_trackingExpiresAtMs", {
                    get: $util.oneOfGetter($oneOfFields = ["trackingExpiresAtMs"]),
                    set: $util.oneOfSetter($oneOfFields)
                });
                ...
                Post.encode = function (message, writer, _depth) {
                    ...
                    if (message.trackingEnabled != null && $Object.hasOwnProperty.call(message, "trackingEnabled"))
                        writer.uint32(/* id 27, wireType 0 =*/216).bool(message.trackingEnabled);
                    if (message.trackingExpiresAtMs != null && $Object.hasOwnProperty.call(message, "trackingExpiresAtMs"))
                        writer.uint32(/* id 28, wireType 0 =*/224).int64(message.trackingExpiresAtMs);
                    if (message.$unknowns != null && $Object.hasOwnProperty.call(message, "$unknowns"))
                        for (let i = 0; i < message.$unknowns.length; ++i)
                            writer.raw(message.$unknowns[i]);
                    return writer;
                ...
                Post.decode = function (reader, length, _end, _depth, _target) {
                    ...
                    while (reader.pos < end) {
                        ...
                        case 27: {
                                if (wireType !== 0)
                                    break;
                                message.trackingEnabled = reader.bool();
                                message._trackingEnabled = "trackingEnabled";
                                continue;
                            }
                        case 28: {
                                if (wireType !== 0)
                                    break;
                                message.trackingExpiresAtMs = reader.int64();
                                message._trackingExpiresAtMs = "trackingExpiresAtMs";
                                continue;
                            }
                        }
                        reader.skipType(wireType, _depth, tag);
